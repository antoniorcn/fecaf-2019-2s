...
public class Argo104P implements Carro, CarroPortas {
	...
	public void ligarMotor() {
		System.out.println("Fiat - Argo motor 1.0 está ligado");
	}

	@Override
	public void desligarMotor() {
		System.out.println("Fiat - Argo motor 1.0 está desligado");
	}
