...
public class Creta202P implements Carro, CarroPortas {
	...
	public void ligarMotor() {
		System.out.println("Hyundai - Creta motor 2.0 está ligado");
	}

	@Override
	public void desligarMotor() {
		System.out.println("Hyundai - Creta motor 2.0 está desligado");
	}
	...
	public void dadosComputadorBordo() {
		System.out.println("Combustível Flex - consumo de 15km/litro");
	}
